...
import { Filter, Pen, Search, DeleteFill, FilterDark, PenDark, DeleteDark } from '../../assets/svgs/svg-icons'
    ...
    <section className='mt-[4rem]'>
         <div className="filter flex justify-between w-[95%] gap-[3rem]">
            <div className="input-container relative w-[70%]">
                ...
                <input type="text" className='bg-accent-4 dark:bg-cream w-full py-[.75rem] px-[3.5rem] dark:text-accent-5 rounded-[1.875rem] outline-none' placeholder='Search by name, or product no...'/>
            </div>
                ...
                <th className='h-[4.25rem] px-[2rem] flex justify-content items-center  gap-[1rem]'>
                    ...
                    <hgroup className='flex relative gap-[0.65rem] items-center justify-center'>
                        <input
                            type='checkbox'
                            id='remember-me'
                            className='w-[1.5rem] h-[1.5rem] appearance-none rounded-[0.313rem] shrink-0 checked:bg-white border-solid border-coffee-brown border-[1px] focus:outline-none peer cursor-pointer'
                        />
                        <label
                            htmlFor='remember-me'
