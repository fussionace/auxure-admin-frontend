...
const Dashboard = ({ toggleTheme, darkTheme, openSidebar }) => {
  return (
    <div
      className={
        openSidebar
          ? "font-primary p-[2rem] md:ml-[18.125rem] bg-light-gray dark:bg-dark-background min-h-screen mx-auto"
          : "font-primary p-[2rem] md:ml-[8.125rem] bg-light-gray dark:bg-dark-background min-h-screen mx-auto"
      }
    >
      {/* nav */}
