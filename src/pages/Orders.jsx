...
const Orders = ({ toggleTheme, darkTheme, openSidebar }) => {
  ...
  return (
    ...
    >
        ...
        <div className="title-container flex items-center gap-[2.5rem]">
          ...
          <div className="switch w-[9.5625rem] h-[2.125rem] bg-white dark:bg-dark-primary dark:text-white rounded-[.3125rem] flex items-center justify-between gap-[.4rem] px-[.2rem]">
            <button
              ...
              className={
                !activeButton
                  ? "h-[1.75rem] rounded-[.3125rem] bg-accent-2 dark:bg-dark-background dark:text-white text-[.875rem] font-light w-full"
                  : "text-[.875rem] font-light text-center w-full"
              }
            >
              Daily
            </button>
      ...
      <section className="tabs  mt-[3rem] after:block after:h-[.125rem] after:w-full after:bg-gray">
        <ul className="flex gap-[2.375rem]">
          <TabNavItem
            title="All Orders"
            id="tab1"
            activeTab={activeTab}
