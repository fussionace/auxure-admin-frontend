...
import { Moon, Alert, AlertDark, NewMessage, ArrowDown, Sun, ArrowdownDark, Search, Edit, Recycle, Lock  } from '../assets/svgs/svg-icons'
  ...
  return (
    <div className='ml-[18.125rem] p-[2rem] bg-accent dark:bg-dark-background min-h-screen'>
      <hgroup className="title-container flex items-center justify-between mb-[3rem] mr-[4rem]">
        <h1 className='font-medium dark:text-white md:text-[2rem]'>Customers</h1>        
      ...
      <div className="search relative mb-[1.3rem]">
        <input type="text"  className='rounded-[1.875rem] py-[.75rem] pr-[10.6875rem] pl-[3.2rem] outline-none' placeholder='Search...'/>
                ...
                <tr className='border-b-2 border-accent-3' key={customer.name}>
                  <td className='px-[2rem] text-[.875rem] font-light h-[5rem] flex items-center gap-[.5rem]'>
                    ...
                    <div className="name_flex flex flex-col gap-[.3rem]">
                      <span className="block text-[.875rem] font-light text-black dark:text-white">{customer.name}</span>
                      <span className="block text-[.75rem] font-light text-gray">{customer.email}</span>
                    </div>
                  </td>
                  <td className='text-[.875rem] font-light'>{ customer.phone }</td>
                  <td className='text-[.875rem] font-light'>{ customer.created }</td>
                  <td>
